...
export class TicTacToeNg2AppComponent implements OnInit {
  ...
  public set easyMode(easy: boolean) {
    this.strategy.easyMode = easy;
  }
  ...
  private computerMove(): void {
    ...
    this.strategy.executeStrategy(this.matrix.winLines, this.matrix.computerTurn === 
      GameState.XTurn ? State.X : State.O);
    this.matrix.advanceBoardState();
    this.updateStats();
  }
